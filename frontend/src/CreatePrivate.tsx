    ...
    <main className="create-account-page">
      ...
      <div className="register-card">
        <div className="card-header">
          ...
          <p>
            Create a game for your friends that they can join with a password
          </p>
        </div>
        ...
        >
          ...
          <div className="input-group">
            <label>Password for the game</label>
            <input
              type="text"
              placeholder="Password for your friends to join with"
              value={password}
              onChange={(e) =>
        ...
        <Modal
          ...
          title="Created the private lobby"
          message="Private lobby created you can now join it on the main screen"
